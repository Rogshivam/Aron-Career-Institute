  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-black to-gray-900">
      <div className="bg-slate-900 shadow-md rounded-lg p-6 w-full max-w-md">
        <h2 className="text-xl font-bold text-center mb-4 text-white">Change Email (Admin)</h2>

        <label className="block mb-2 font-semibold text-white">Current Email</label>
        <input type="email" name="email" value={email} onChange={onChange}
          className="w-full border-blue-500 bg-slate-700 text-white px-3 py-2 rounded mb-4" required />

        <label className="block mb-2 font-semibold text-white">New Email</label>
