...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-r from-black to-gray-900">
      <div className="w-full max-w-md bg-slate-900 rounded-2xl shadow-lg p-8">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full border  px-3 py-2 rounded-md border-blue-500 bg-slate-700 text-white"
        ...
        <div className="mb-4">
          ...
          <select
            ...
            value={formData.role}
            onChange={handleChange}
            className="w-full border border-blue-500 bg-slate-700 text-white px-3 py-2 rounded-md  "
          >
          ...
          <>
            <div className="mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 block  shadow-sm w-full border  px-3 py-2 rounded-md border-blue-500 bg-slate-700 text-white"
            ...
            <div className="mb-6">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 block w-full  shadow-sm border  px-3 py-2 rounded-md border-blue-500 bg-slate-700 text-white"
      ...
      {showOtpModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-30">
          <div className="bg-slate-900 rounded-xl shadow-lg w-11/12 max-w-md p-6 relative animate-fade-in">
            ...
            <div className="flex justify-end space-x-2">
              <button
                ...
                className="px-4 py-2 rounded-md border text-white border-gray-300 hover:bg-gray-100"
              >
                Cancel
              </button>
              <button
