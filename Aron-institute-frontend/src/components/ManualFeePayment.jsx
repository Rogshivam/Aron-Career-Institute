...
export default function ManualFeePayment({ student, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-900 to-blue-950 p-6 rounded shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              type="number"
              text="Enter Amount"
              className="w-full px-3 py-2 border rounded bg-slate-700 text-white border-none focus:outline-none focus:ring-2 focus:ring-blue-400"
              value={amount}
          ...
          <div>
            ...
            <select
              className="w-full px-3 py-2 border-none border-blue rounded bg-slate-700"
              value={method}
