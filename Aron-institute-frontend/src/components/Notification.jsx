...
export default function Notification() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 bg-gradient-to-r from-blue-950 via-slate-900 to-slate-800 shadow-lg rounded-lg p-6">
      <h2 className="text-2xl font-semibold text-white mb-4">Send Notification</h2>
      <textarea
        className="w-full border border-none bg-slate-700  px-3 py-2  rounded-md p-3 mb-4 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
        rows="4"
