...
// Route: Set password for student using: POST "/api/students/set-password"
// 📍 Route: Set password for student using: POST "/api/students/set-password"
router.post("/set-password", async (req, res) => {
  try {
    ...
    // Optional: Check if password already exists to prevent overwriting
    if (student.password) {
...
//   try {
//     const students = await Student.find(); // or Student.find({ user: req.user.id }) if scoped
//     res.json(students);
//   } catch (error) {
